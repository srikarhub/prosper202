	...
	<table class="table table-bordered table-hover" id="stats-table">
		<thead>
			<tr style="background-color: #f2fbfa;">   
				<th colspan="2" style="text-align:left"><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_order']; ?>');">Time</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_clicks_order']; ?>');">Clicks</a></th> 
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_click_throughs_order']; ?>');">Click Throughs</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_ctr_order']; ?>');">LP CTR</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_leads_order']; ?>');">Leads</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_su_ratio_order']; ?>');">Avg S/U</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_payout_order']; ?>');">Avg Payout</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_epc_order']; ?>');">Avg EPC</a></th> 
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_avg_cpc_order']; ?>');">Avg CPC</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_income_order']; ?>');">Income</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_cost_order']; ?>');">Cost</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_net_order']; ?>');">Net</a></th>
				<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_hourly.php','','<?php echo $html['sort_breakdown_roi_order']; ?>');">ROI</a></th>
			</tr>  
		</thead>
		<tbody>
		<?php while ($breakdown_row = $breakdown_result->fetch_array(MYSQL_ASSOC)) { 
			...
			$html['sort_breakdown_clicks'] = htmlentities(number_format($breakdown_row['sort_breakdown_clicks']), ENT_QUOTES, 'UTF-8');
			$html['sort_breakdown_click_throughs'] = htmlentities(number_format($breakdown_row['sort_breakdown_click_throughs']), ENT_QUOTES, 'UTF-8');
			...
			$html['sort_breakdown_epc'] = htmlentities(dollar_format($breakdown_row['sort_breakdown_income']/$breakdown_row['sort_breakdown_clicks']), ENT_QUOTES, 'UTF-8');
			...
			<tr>
				...
				<td><?php echo $html['sort_breakdown_clicks']; ?></td>
				<td><?php echo $html['sort_breakdown_click_throughs']; ?></td>
		...
		<?php   error_reporting(0); 
			$rows = $breakdown_result->num_rows;
