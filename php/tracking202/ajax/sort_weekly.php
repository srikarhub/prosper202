...
<div class="row">
	...
	<table class="table table-bordered table-hover" id="stats-table">
		...
		<tr style="background-color: #f2fbfa;">   
			<th colspan="2" style="text-align:left"><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_weekly.php','','<?php echo $html['sort_breakdown_order']; ?>');">Time</a></th>
			...
			<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_weekly.php','','<?php echo $html['sort_breakdown_click_throughs_order']; ?>');">Click Throughs</a></th>
			<th><a class="onclick_color" onclick="loadContent('/tracking202/ajax/sort_weekly.php','','<?php echo $html['sort_breakdown_ctr_order']; ?>');">LP CTR</a></th> 
